...
struct ReviewRequestServiceTests {
    ...
    func recordPlaybackStartedIncrementsCount() async {
        ...
        // Then
        #expect(defaults.integer(forKey: "reviewRequest.actionCount") == 1)
    }
    ...
    func mixedActionsIncrementCount() async {
        ...
        // Then
        #expect(defaults.integer(forKey: "reviewRequest.actionCount") == 3)
    }
    ...
    func shouldNotRequestIfAlreadyRequested() async {
        // Given
        let defaults = InMemoryDefaults()
        defaults.set("1.0", forKey: "reviewRequest.lastRequestedVersion")
        let service = ReviewRequestService(
            storage: defaults,
            minimumVersionForReview: "1.0"
        )
    ...
    func didRequestReviewResetsState() async {
        ...
        // Then
        #expect(service.shouldRequestReview == false)
        #expect(defaults.integer(forKey: "reviewRequest.actionCount") == 0)
        #expect(defaults.string(forKey: "reviewRequest.lastRequestedVersion") == "1.0")
    }
    ...
    func versionComparisonSemantic() async {
        ...
        let defaults = InMemoryDefaults()
        defaults.set("1.9", forKey: "reviewRequest.lastRequestedVersion")
    ...
    func noReviewWhenMinimumVersionLower() async {
        ...
        let defaults = InMemoryDefaults()
        defaults.set("2.0", forKey: "reviewRequest.lastRequestedVersion")
