...
@Wallpaper
@Observable
public final class WXYCGradientWithNoiseWallpaper: WallpaperProtocol {
    ...
    public func configure() {
        ...
        if defaults.object(forKey: intensityKey) != nil {
            self.intensity = defaults.float(forKey: intensityKey)
        }
        if defaults.object(forKey: frequencyKey) != nil {
            self.frequency = defaults.float(forKey: frequencyKey)
        }
    }
