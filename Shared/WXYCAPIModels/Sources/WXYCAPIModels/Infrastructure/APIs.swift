...
open class WXYCAPIAPIConfiguration: @unchecked Sendable {
    ...
    public static let shared = WXYCAPIAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: WXYCAPIAPIConfiguration
    ...
    required public init(
        ...
        apiConfiguration: WXYCAPIAPIConfiguration = WXYCAPIAPIConfiguration.shared
    ) {
        self.method = method
