...
public struct FilingRotationRequest: Sendable, Codable, Hashable {
    ...
    public init(rotationBin: RotationBin, cardId: Int? = nil, urls: [String]? = nil) {
...
extension FilingRotationRequest: UnknownCaseCheckable {
