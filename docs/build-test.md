...
- `ListenerAuthTests/AuthNetworkClient E2E Tests` — real Backend-Service auth endpoint
...
RUN_E2E=1 swift test --package-path Shared/ListenerAuth --filter AuthNetworkClient
