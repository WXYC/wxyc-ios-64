...
public class RemoteAudioSource: AudioStreamSource, @unchecked Sendable {
    ...
    private func addStreamOperation(_ block: @escaping @Sendable () -> Void) {
    ...
    ///
    /// - Parameter block: A closure to be executed
    private func addCompletionOperation(_ block: @escaping @Sendable () -> Void) {
        let operation = BlockOperation(block: block)
