...
struct ConcertRow: View {
    ...
    private var presenter: BoxOfficeTicketPresenter { BoxOfficeTicketPresenter(concert) }
    ...
    private var accessibilityLabel: String {
        [concert.headlineName, venueLine, presenter.dateLabel, presenter.feedTagText]
            .joined(separator: ", ")
    }
